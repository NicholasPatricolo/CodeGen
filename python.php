...
<div class="container-fluid">
    ...
    <h1>Quasiasi cosa mi scrivi o mi chiedi io lo convertiro in codice <strong>Python</strong></h1>
    <br>
     </div>
...
<?php
    ...
    if (isset($_GET['prompt'])) {
        ...
        $prompt = $comandosolocodice .$_GET['prompt'] . "in Python";
        $temperature = 0;
        $max_tokens = 2048;
        $top_p = 1;
        $n = 1;
